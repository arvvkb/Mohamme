...
block_id=[]
import langdetect
if os.getenv('6459225544:AAHazQhdUva6JRjjql8p_1NjKkmL0zlWgHk')!=None:
    def texttosp(text):
...
ايدي المستخدم:- {update.effective_chat.id}""", parse_mode="HTML")
     ...
     if update.message.text=="/start":
      if str(update.effective_chat.id) in admin_id:
       ...
       [InlineKeyboardButton("قناة البوت [👁] ", url="https://t.me/x_yl1l")],
       ]
       ...
       keyboard = [
              [InlineKeyboardButton("مطور البوت", url="https://t.me/x_y1l"),InlineKeyboardButton("قناة المطور", url="https://t.me/X_Yl1l")],
             ]
       reply_markup = InlineKeyboardMarkup(keyboard)
       update.message.reply_text(f"""بوت ادمن بنل
تظهر هذه الرساله في حال كنت انت لست المطور او لم تضع ايديك
مطور """, reply_markup=reply_markup)
